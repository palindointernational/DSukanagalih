<div id="page-loader" class="fixed inset-0 flex items-center justify-center bg-white z-[9999]">

    <div role="status">
        <svg aria-hidden="true" class="inline w-12 h-12 text-white animate-spin fill-orange-500" viewBox="0 0 100 101"
    ...
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0">
                <a href="/" class="flex items-center">
                    <img src="img/logo.png" class="h-7 me-3" alt="FlowBite Logo" />
                    <span class="text-white self-center text-2xl font-semibold whitespace-nowrap">SANUBARI</span>
                </a>
            </div>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-white sm:text-center">© 2023 <a href="#"
                    class="hover:underline">SANUBARI</a>. All Rights Reserved.
            </span>
