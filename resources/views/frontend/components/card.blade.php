        ...
        <div class="grid gap-8 mb-6 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1">
            <div class="flex flex-col items-center bg-white rounded-lg shadow-sm md:flex-row md:max-w-xl">
                ...
                <div class="flex flex-col justify-between p-4 leading-normal">
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900">Make Donation
                    </h5>
            ...
            <div class="flex flex-col items-center bg-white rounded-lg shadow-sm md:flex-row md:max-w-xl">
                ...
                <div class="flex flex-col justify-between p-4 leading-normal">
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900">Become A
                        Volunteer</h5>
                    <p class="mb-3 font-normal text-gray-700">Here are the biggest enterprise
                        technology acquisitions of 2021 so far, in reverse chronological order.</p>
                </div>
            ...
            <div class="flex flex-col items-center bg-white rounded-lg shadow-sm md:flex-row md:max-w-xl">
                ...
                <div class="flex flex-col justify-between p-4 leading-normal">
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900">Sponsorship
                    </h5>
                    <p class="mb-3 font-normal text-gray-700">Here are the biggest enterprise
                        technology acquisitions of 2021 so far, in reverse chronological order.</p>
                </div>
